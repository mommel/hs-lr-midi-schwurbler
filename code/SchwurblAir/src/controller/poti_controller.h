 ...
 */
#pragma once
#ifndef SCHWURBLERAIR_CONTROLLER_POTICONTROLLER_H_
#define SCHWURBLERAIR_CONTROLLER_POTICONTROLLER_H_
...
class PotiController {
 public:
   ...
   *
   */
  PotiController(int amount, std::initializer_list<int> pinList,
